...
var FFI = {};
FFI.Defined = Fay.FFI.Defined;
FFI.Null = Fay.FFI.Null;
FFI.Nullable = Fay.FFI.Nullable;
FFI.Undefined = Fay.FFI.Undefined;
var Main = {};
Main.Event = function(pluginName){
  return function(eventDate){
    return function(desc){
      return function(extraInfo){
        return function(fullContents){
          return new Fay$$$(function(){
            return new Main._Event(pluginName,eventDate,desc,extraInfo,fullContents);
          });
        };
      };
    };
...
Main.pluginName = function(x){
  return new Fay$$$(function(){
    return Fay$$_(x).pluginName;
  });
};
Main.eventDate = function(x){
  return new Fay$$$(function(){
    return Fay$$_(x).eventDate;
  });
};
Main.desc = function(x){
  return new Fay$$$(function(){
    return Fay$$_(x).desc;
  });
};
Main.extraInfo = function(x){
  return new Fay$$$(function(){
    return Fay$$_(x).extraInfo;
  });
};
Main.fullContents = function(x){
  return new Fay$$$(function(){
    return Fay$$_(x).fullContents;
  });
};
Main.main = new Fay$$$(function(){
  return Fay$$_(Fay$$_(Main.ajax)(Fay$$list("/timesheet/2013-07-01")))(Main.processResults);
});
Main.processResults = function($p1){
  return new Fay$$$(function(){
    var events = $p1;
    return (function(){
      var eventsTable = new Fay$$$(function(){
        return Fay$$_(Main.nodes)(Fay$$list("table#eventsTable"));
      });
      var processResult = function($p1){
        return new Fay$$$(function(){
          var event = $p1;
          return Fay$$_(Fay$$_(Fay$$bind)(eventsTable))(Fay$$_(Fay$$_(Prelude.$36$)(Main.append))(Fay$$_(Main.makeEventRow)(event)));
        });
      };
      return Fay$$_(Fay$$_(Prelude.mapM_)(processResult))(events);
    })();
  });
};
Main.makeEventRow = function($p1){
  return new Fay$$$(function(){
    var event = $p1;
    return Fay$$_(Fay$$_(Prelude.$36$)(Main.makeTableRow))(Fay$$_(Fay$$_(Prelude.map)(function($p1){
      var $gen_1 = $p1;
      return Fay$$_(Fay$$_(Prelude.$36$)($gen_1))(event);
    }))(Fay$$list([function($p1){
      var x = $p1;
      return Fay$$_(Fay$$_(Prelude.$36$)(Main.formatTime))(Fay$$_(Main.eventDate)(x));
    },Main.pluginName,Main.desc,Main.extraInfo])));
  });
};
Main.makeTableRow = function($p1){
  return new Fay$$$(function(){
    var cols = $p1;
    return Fay$$_(Fay$$_(Prelude.$43$$43$)(Fay$$list("\u003ctr\u003e\u003ctd\u003e")))(Fay$$_(Fay$$_(Prelude.$43$$43$)(Fay$$_(Fay$$_(Prelude.intercalate)(Fay$$list("\u003c/td\u003e\u003ctd\u003e")))(cols)))(Fay$$list("\u003c/td\u003e\u003c/tr\u003e")));
  });
};
Main.formatTime = function($p1){
  return new Fay$$$(function(){
    return Fay$$jsToFay_string(formatTime(Fay$$fayToJs_string($p1)));
  });
};
Main.ajax = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["unknown"],jQuery.ajax(Fay$$fayToJs_string($p1), {'type': 'GET', contentType: 'text/json', processData: false, 'success' : Fay$$fayToJs(["function",[["automatic"],["action",[["unknown"]]]]],$p2) })));
    });
  };
};
Main.nodes = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],jQuery(Fay$$fayToJs_string($p1))));
  });
};
Main.append = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],Fay$$fayToJs(["user","JQuery",[]],$p2).append(Fay$$fayToJs_string($p1))));
    });
  };
};
Main._Event = function Event(pluginName,eventDate,desc,extraInfo,fullContents){
...
Fay$$objConcat(Fay$$fayToJsHash,{"Event": function(type,argTypes,_obj){
  var obj_ = {"instance": "Event"};
  var obj_pluginName = Fay$$fayToJs_string(_obj.pluginName);
  if (undefined !== obj_pluginName) {
    obj_['pluginName'] = obj_pluginName;
  }
  var obj_eventDate = Fay$$fayToJs_string(_obj.eventDate);
  if (undefined !== obj_eventDate) {
    obj_['eventDate'] = obj_eventDate;
  }
  var obj_desc = Fay$$fayToJs_string(_obj.desc);
  if (undefined !== obj_desc) {
    obj_['desc'] = obj_desc;
  }
  var obj_extraInfo = Fay$$fayToJs_string(_obj.extraInfo);
  if (undefined !== obj_extraInfo) {
    obj_['extraInfo'] = obj_extraInfo;
  }
  var obj_fullContents = Fay$$fayToJs_string(_obj.fullContents);
  if (undefined !== obj_fullContents) {
    obj_['fullContents'] = obj_fullContents;
  }
  return obj_;
}});
Fay$$objConcat(Fay$$jsToFayHash,{"Event": function(type,argTypes,obj){
  return new Main._Event(Fay$$jsToFay_string(obj["pluginName"]),Fay$$jsToFay_string(obj["eventDate"]),Fay$$jsToFay_string(obj["desc"]),Fay$$jsToFay_string(obj["extraInfo"]),Fay$$jsToFay_string(obj["fullContents"]));
}});
